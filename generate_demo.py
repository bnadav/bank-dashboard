...
CARDS = ['1234', '5678']  # fake digits — real cards are gitignored
MONTHS = [(1, 2026), (2, 2026), (3, 2026)]  # months to generate

# (merchant, charge_min, charge_max, card, txn_type, is_installment)
LOCAL_TEMPLATES = [
    ('פז תחנת דלק',        250,  400, '1234', 'עסקה רגילה',     False),
    ('Yellow פז',            40,   85, '1234', 'עסקה רגילה',     False),  # < 100 → Yellow category
    ('Yellow חניון',         25,   70, '5678', 'עסקה רגילה',     False),  # < 100 → Yellow category
    ('דרך ארץ כביש 6',       30,  120, '5678', 'עסקה רגילה',     False),
    ('מגדל ביטוח',          350,  600, '1234', 'הוראת קבע',      False),
    ('ביטוח לאומי',         200,  400, '5678', 'הוראת קבע',      False),
    ('פרטנר תקשורת',        120,  200, '1234', 'הוראת קבע',      False),
    ('HOT Mobile',           80,  150, '5678', 'הוראת קבע',      False),
    ('שופרסל דיל',          200,  500, '1234', 'עסקה רגילה',     False),
    ('רמי לוי שיווק',       150,  400, '5678', 'עסקה רגילה',     False),
    ('סופר פארם',            80,  200, '1234', 'עסקה רגילה',     False),
    ('ארומה קפה',            35,   80, '1234', 'עסקה רגילה',     False),
    ('WOLT הזמנה',           60,  150, '5678', 'עסקה רגילה',     False),
    ('רולדין',               40,  100, '1234', 'עסקה רגילה',     False),
    ('קופת חולים מכבי',      30,   80, '5678', 'עסקה רגילה',     False),
    ('בית חולים הדסה',      100,  300, '1234', 'עסקה רגילה',     False),
    ('NETFLIX',              60,   60, '1234', 'הוראת קבע',      False),
    ('GOOGLE ONE',           10,   15, '5678', 'הוראת קבע',      False),
    ('IKEA ראשון לציון',    200,  400, '1234', 'תשלומים - רגיל', True),   # installment
    ('דלתא גלריה',          100,  300, '5678', 'עסקה רגילה',     False),
    ('אולימפוס ספורט',      150,  250, '1234', 'הוראת קבע',      False),
    ('אור ירוק גן ילדים',   800, 1200, '5678', 'הוראת קבע',      False),
    ('BIT העברה',            50,  300, '1234', 'עסקה רגילה',     False),
    ('עיגול לטובה',           5,   30, '5678', 'עסקה רגילה',     False),
    ('פועלים- דמי כרטיס',   12,   12, '1234', 'דמי כרטיס',      False),
    ('פועלים- דמי כרטיס',   12,   12, '5678', 'דמי כרטיס',      False),
    ('חנות שונות בע"מ',      50,  200, '1234', 'עסקה רגילה',     False),
]

# Credit/refund transaction added per month
CREDIT_TEMPLATE = ('רמי לוי שיווק - זיכוי', -150, -40, '5678', 'זיכוי')

# (merchant, currency, ils_min, ils_max, orig_min, orig_max, card)
FOREIGN_TEMPLATES = [
    ('SPOTIFY',         'USD',  38,   42,  10.99, 10.99, '1234'),
    ('AIRBNB STAY',     'USD', 500, 1200, 140.0, 330.0,  '5678'),
    ('BOOKING.COM',     'EUR', 300,  900,  75.0, 225.0,  '1234'),
]
